    ...
    *  in HP Service Test.
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            _flow.Sequence7.Activities.Add (_flow.ConcatenateStringsActivity6);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><GetFlightOrdersResponse xmlns=""HP.SOAQ.SampleApp""><GetFlightOrdersResult><FlightOrder><CustomerName p1:nil=""true"" /></FlightOrder><FlightOrder><CustomerName p1:nil=""true"" /></FlightOrder><FlightOrder><CustomerName p1:nil=""true"" /></FlightOrder></GetFlightOrdersResult></GetFlightOrdersResponse></Body></Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><DeleteFlightOrder xmlns=""HP.SOAQ.SampleApp""><OrderNumber>{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightOrdersResponse.GetFlightOrdersResult.FlightOrder.Count}</OrderNumber></DeleteFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi1 = new VTDPropertyInfoBase("OutputEnvelope","count(/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightOrdersResponse'][1]/*[local-name(.)='GetFlightOrdersResult'][1]/*[local-name(.)='FlightOrder'])");
            VTDBaseGetter binding_getter1 = new VTDXPathGetter(pi1);
            VTDPropertyInfoBase pi2 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='DeleteFlightOrder'][1]/*[local-name(.)='OrderNumber'][1]");
...
@"<OutputAttachments />");
            ...
            _flow.ConcatenateStringsActivity6.Prefix = @"";
